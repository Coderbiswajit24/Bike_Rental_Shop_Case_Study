...
insert into customers values(2,	'Alice Smith',		'alice.smith@example.com');
insert into customers values(3,	'Bob Johnson',		'bob.johnson@example.com');
insert into customers values(4,	'Eva Brown',		'eva.brown@example.com');
insert into customers values(5,	'Michael Lee',		'michael.lee@example.com');
insert into customers values(6,	'Sarah White',		'sarah.white@example.com');
insert into customers values(7,	'David Wilson',		'david.wilson@example.com');
insert into customers values(8,	'Emily Davis',		'emily.davis@example.com');
insert into customers values(9,	'Daniel Miller',	'daniel.miller@example.com');
insert into customers values(10,	'Olivia Taylor',	'olivia.taylor@example.com');


insert into bikes values(1,	'Mountain Bike 1'	,'mountain bike'	,10.00	,50.00	,'available');
insert into bikes values(2,	'Road Bike 1'	,'road bike',12.00	,60.00	,'available');
insert into bikes values(3,	'Hybrid Bike 1'	,'hybrid'	,8.00	,40.00	,'rented');
insert into bikes values(4,	'Electric Bike 1'	,'electric',15.00	,75.00	,'available');
insert into bikes values(5,	'Mountain Bike 2'	,'mountain bike'	,10.00	,50.00	,'out of service');
insert into bikes values(6,	'Road Bike 2'	,'road bike',12.00	,60.00	,'available');
insert into bikes values(7,	'Hybrid Bike 2'	,'hybrid'	,8.00	,40.00	,'out of service');
insert into bikes values(8,	'Electric Bike 2'	,'electric',15.00	,75.00	,'available');
insert into bikes values(9,	'Mountain Bike 3'	,'mountain bike'	,10.00	,50.00	,'rented');
insert into bikes values(10,	'Road Bike 3'	,'road bike',12.00	,60.00	,'available');
